    ...
    private void drawPanorama(int mouseX, int mouseY, float partialTicks)
    {
        ...
        for (int j = 0; j < 2; ++j)
        {
            ...
            for (int k = 0; k <6; ++k)
            {
                ...
                Vec4 firstVertice = new Vec4(fiVM.x,fiVM.y,fiVM.z,1.0f);
                Vec4 secondVertice = new Vec4(seVM.x,seVM.y,seVM.z,1.0f);
                Vec4 thirdVertice = new Vec4(thVM.x,thVM.y,thVM.z,1.0f);
                Vec4 fourthVertice = new Vec4(foVM.x,foVM.y,foVM.z,1.0f);
